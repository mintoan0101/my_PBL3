...
namespace pbl
{
    public partial class KhachHang_Them : Form
    {
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            else if (!Check_Do_Dai_SDT()) mess = "Số điện thoại nhập vào phải có đúng 10 chữ số. ";
            else if (!Check_Diem_Hop_Le()) mess = "Điểm nhập vào không hợp lệ.";
        ...
        {
            if(String.IsNullOrEmpty(txt_sdt.Text) || String.IsNullOrEmpty(txt_ten.Text))
            {
                return false;
            }
            return true;
        ...
        private bool Check_Diem_Hop_Le()
        {
            if(txt_diem.Text.Trim().All(char.IsDigit))
            {
                return true;
            }
            return false;
